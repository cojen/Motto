 ...
 */
public final class ClassFieldItem extends BaseItem implements BaseFieldItem {
     ...
     * @see Modifiers
     */
    ClassFieldItem(int modifierBits, BaseClassTypeItem enclosingClass, BaseType type, String name) {
        super(modifierBits);
